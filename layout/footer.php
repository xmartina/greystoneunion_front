    ...
    <div class="container">
        <div class="row gy-3 justify-content-between align-items-center">
            <div class="col-xxl-5 col-xl-6 col-lg-4 text-lg-start text-center wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                <h4 class="text-white">Subscribe to our newsletter and stay connected</h4>
            </div>
            <div class="col-xxl-7 col-xl-6 col-lg-8 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                <form class="subscribe-form" id="subscribeForm">
                    <input type="hidden" name="_token" value="UG60kz8dVFxWuK739qKuMEoVtUioo3JVTbcyDlwT">                        <div class="custom-icon-field">
                        <input type="email" name="email" class="form-control form--control" placeholder="Enter email address">
                        <i class="las la-envelope"></i>
                    </div>
                    <button type="submit" class="btn btn--base h-auto">Subscribe</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-2 col-sm-6 order-lg-3 order-4">
                <div class="footer-widget">
                    ...
                    <ul class="short-link-list">
                        <li>
                            <a href="policy/company-policy/111.html">
                                Company Policy
                            </a>
                        </li>
                        <li>
                            <a href="policy/privacy-policy/117.html">
                                Privacy Policy
                            </a>
                        </li>
                        <li>
                            <a href="policy/terms-of-service/118.html">
                                Terms of Service
                            </a>
                        </li>
                    </ul>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="#" method="post">
                <input type="hidden" name="_token" value="UG60kz8dVFxWuK739qKuMEoVtUioo3JVTbcyDlwT">                                            <div class="modal-body">
                    <div class="text-center"><i class="la la-times-circle text--danger la-6x" aria-hidden="true"></i></div>
                    <h3 class="text-center mt-3">You are not logged in!</h3>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn--dark" data-bs-dismiss="modal" aria-label="Close">Close</button>
                </div>
                    ...
                    messaging
                        ...
                        .then(function(token) {
                            $.ajax({
                                ...
                                data: {
                                    token: token,
                                    '_token': "UG60kz8dVFxWuK739qKuMEoVtUioo3JVTbcyDlwT"
                                },
                                success: function(response) {
