                    ...
                    <div class="col-xxl-8 col-xl-10 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.3s">
                        <div class="about-card">
                            ...
                            <div class="about-card__content">
                                ...
                                <p>Empowering individuals and businesses with seamless, secure, and innovative digital
                                    banking solutions.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-10">
                <div class="section-header text-center">
                    ...
                    <p class="mt-3 text-white">Our seamless banking services are available worldwide, ensuring secure
                        and hassle-free transactions.</p>
                </div>
            </div>
        </div>
        ...
        <div class="testimonial-slider wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
            <div class="single-slide">
                <div class="testimonial-item">
                    ...
                    <p class="text-white mt-2">Their 24/7 customer service is amazing! Every issue I had was resolved
            ...
            <div class="single-slide">
                <div class="testimonial-item">
                    <div class="ratings">
                        <i class="la la-star"></i><i class="la la-star"></i><i class="la la-star"></i><i
                            class="la la-star"></i><i class="la la-star"></i></div>
                    <p class="text-white mt-2">Getting a loan was super easy, with flexible repayment options. Greystone
                        Union truly cares about its customers.</p>
                    <div class="d-flex align-items-center mt-4">
            ...
            <div class="single-slide">
                <div class="testimonial-item">
                    <div class="ratings">
                        <i class="la la-star"></i><i class="la la-star"></i><i class="la la-star"></i><i
                            class="la la-star"></i><i class="la la-star"></i></div>
                    <p class="text-white mt-2">I love the security features, especially the OTP and 2FA options. I feel
                        confident knowing my funds are protected.</p>
                    <div class="d-flex align-items-center mt-4">
            ...
            <div class="single-slide">
                <div class="testimonial-item">
                    <div class="ratings">
                        <i class="la la-star"></i><i class="la la-star"></i><i class="la la-star"></i><i
                            class="la la-star"></i><i class="la la-star"></i></div>
                    <p class="text-white mt-2">Greystone Union has completely transformed how I manage my finances. The
                        app is user-friendly, and transactions are instant. Highly recommend!</p>
                    <div class="d-flex align-items-center mt-4">
